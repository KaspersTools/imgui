...
void MainWindow::render() {
	...
	//sidebars
	{
		...
		if (HBUI::beginSideBar(             //begin the side bar
			...
			HBUI::sideBarBarButton(ImGui::GetID("BTN2"), "BTN2", {0, 0}, {54, 54}, {0, 0}, {0, 0, 0, 0}, m_ButtonMargin);
			HBUI::sideBarBarButton(ImGui::GetID("BTN3"), "BTN3", {0, 0}, {54, 54}, {0, 0}, {0, 0, 0, 0}, m_ButtonMargin);
			HBUI::sideBarBarButton(ImGui::GetID("BTN4"), "BTN4", {0, 0}, {54, 54}, {0, 0}, {0, 0, 0, 0}, m_ButtonMargin);
			HBUI::sideBarBarButton(ImGui::GetID("BTN5"), "BTN5", {0, 0}, {54, 54}, {0, 0}, {0, 0, 0, 0}, m_ButtonMargin);
			HBUI::sideBarBarButton(ImGui::GetID("BTN6"), "BTN6", {0, 0}, {54, 54}, {0, 0}, {0, 0, 0, 0}, m_ButtonMargin);
