...
struct HBStyle {
		...
		ImVec2  mainMenuBarVerticalFirstItemOffset   = {0,
																										0};                       //Extra offset for the first item in the vertical mainmenubar
		ImVec2  mainMenuBarHorizontalFirstItemOffset = {0,
																										0};                       //Extra offset for the first item in the vertical mainmenubar
		ImVec2  mainMenuItemSize                     = {32,
																										32};                    //The size of the mainmenu items (width, height) \\ for circles x is used for the radius and y is ignored
